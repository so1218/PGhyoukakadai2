...
//掛け算行列の関数
Matrix3x3 MultiplyMatrix(Matrix3x3 matrix1, Matrix3x3 matrix2)
{
	return
	{
...
Matrix3x3 MakeAffineMatrix(Vector2 scale, float rotate, Vector2 translate)
{
	...
	Matrix3x3 scaleRotateMatrix = MultiplyMatrix(scaleMatrix, rotateMatrix);
	Matrix3x3 affineMatrix = MultiplyMatrix(scaleRotateMatrix, translateMatrix);
